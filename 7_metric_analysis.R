...
dat2  %>% 
  ...
  scale_color_manual(values = c('grey55', 'black'), labels = c('Non-glacial (n = 139)', 'Glacial (n = 33)'))

ggsave("Figures/Figure_S3.png", width = 6.2, height = 3)
...
## Linear model of PC1
mix1 <- lm(data = metric.dat, Dim.1 ~ glacial + scale(rain.20) + scale(snowfall.20) + scale(temp.20) + scale(area_km2_log) + scale(rain.20)*glacial + scale(snowfall.20)*glacial + scale(temp.20)*glacial + scale(area_km2_log)*glacial)
...
mix1 <- lm(data = metric.dat, Dim.2 ~ glacial + scale(rain.20) + scale(snowfall.20) + scale(temp.20) + scale(area_km2_log) + scale(rain.20)*glacial + scale(snowfall.20)*glacial + scale(temp.20)*glacial + scale(area_km2_log)*glacial)
...
mix1 <- lm(data = metric.dat, scale(HSAM_t) ~ glacial + scale(rain.20) + scale(snowfall.20) + scale(temp.20) + scale(area_km2_log) + scale(rain.20)*glacial + scale(snowfall.20)*glacial + scale(temp.20)*glacial + scale(area_km2_log)*glacial)
